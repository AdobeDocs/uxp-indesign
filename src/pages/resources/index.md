...
Start by reading the [fundamentals](fundamentals/index.md), and move to the [recipes](recipes/index.md) that aim to provide bite-size examples for common use cases. And then, explore the APIs in the [References](/indesign/uxp/changelog/) section. 
