...
<!-- TODO Add screen shot of transform panel -->
...
If you are adding, subtracting, multiplying, or dividing specific measurement values, it is recommended to first set the corresponding measurement units, before the operation. At the end, you can set the measurement units back to whatever they were before. 
...
<!-- TODO Give example or point to API docs that lets dev set/get/pverride measurement units -->
