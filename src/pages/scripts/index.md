...
Scripts are the quickest and easiest way to automate tasks. Read the introduction to [Scripts & Plugins](../introduction/next-steps/script-and-plugin/index.md) to understand if scripts are the right fit for your use case before proceeding. 
