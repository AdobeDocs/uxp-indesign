...
## options : `number`
**Read only**
A constant that describes the property type, 0 for a simple property.\<br/\>XMPConst.PROP_IS_ARRAY - The property is an array (of type alt, bag, or seq).\<br/\>XMPConst.PROP_IS_STRUCT - The property is a structure with nested fields.\<br/\>
