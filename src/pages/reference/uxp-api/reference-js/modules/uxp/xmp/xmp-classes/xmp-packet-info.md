...
# XMPPacketInfo
**Since**: v7.2.0
This object is returned by [XMPFile.getpacketinfo](xmp-file.md#getpacketinfo).. The read-only properties describe the XMP packet for the file represented by the [XMPFile object](xmp-file.md).  
