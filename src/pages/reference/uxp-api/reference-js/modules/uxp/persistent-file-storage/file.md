...
you'll get access via a [storage.FileSystemProvider](file-system-provider.md).
...
| --- | --- | --- | --- |
| options | `any` |  |  |
| [options.format] | `Symbol` | `formats.utf8` | The format of the file; see [utf8](formats.md#utf8--symbol) and [binary](formats.md#binary--symbol). |
