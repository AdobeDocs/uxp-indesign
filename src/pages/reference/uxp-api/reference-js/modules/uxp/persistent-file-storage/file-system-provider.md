...
open a file picker to the user's `documents` folder, for example, then [userDocuments](domains.md#module-storage-domains-userdocuments) will be in this list.
...
and folders within can be accessed via [Folder#getEntries](folder.md#getentries). Any
