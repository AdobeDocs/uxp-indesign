...
| .domains | string[] | Allows access to the specified domains. Wildcards (except top-level) are supported. e.g "[https://*.adobe.com](https://*.adobe.com)".  Recommended | Mandatory |
