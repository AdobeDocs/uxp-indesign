...
### How is the UXP SDK different from the InDesign C++ SDK (aka CSDK)?

The two SDKs serve different purposes. The new UXP SDK lets you write any generic C++ code alongside JavaScript. The PS C++ SDK helps you extend InDesign capabilities in seven areas including filters, file formats, and selections.
...
### Can I build a InDesign filter (or other such capabilities) with the new Hybrid plugin SDK?

Yes, see the section under [Getting started](../getting-started/).
