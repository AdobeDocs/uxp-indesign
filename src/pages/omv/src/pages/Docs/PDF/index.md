...
> *Read Only* 
> 
> GraphicLayerOption **graphicLayerOptions** 
>
...
*** 
> PlacedVectorProfilePolicy **grayVectorPolicy** 
>
> The color profile policy for grayscale content in a placed vector.
*** 
> PlacedVectorProfilePolicy **rgbVectorPolicy** 
>
> The color profile policy for RGB content in a placed vector.
*** 
> PlacedVectorProfilePolicy **cmykVectorPolicy** 
>
...
| Object | withProperties | Initial values for properties of the new PDF (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the PDF. |
| Mixed | around | The point around which to flip the PDF. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The location of the new PDF, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | Amount by which to offset the new PDF from the original PDF's position. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the PDF,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the PDF relative to its current position, in the format (x, y). (Optional) |
...
| Boolean | clearingOverrides | If true, clears the PDF's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the PDF that are not defined in the object style. (Optional) |
...
| String | withProperties | Initial values for properties of the new PDF. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The PDF's new shape. |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the PDF in relation to previously selected objects. (Optional) |
