...
| String | withProperties | Initial values for properties of the new Line. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the Line in relation to previously selected objects. (Optional) |
