...
*** 
> Boolean **continueNumbersAcrossStories** 
>
> If true, numbering will continue across stories.
*** 
> Boolean **continueNumbersAcrossDocuments** 
>
...
### Methods
> **remove**( NumberingList **replacingWith** )
> 
> Delete the NumberingList.
#### Parameters
| Type | Name | Description |
|---|---|---|
| NumberingList | replacingWith | The NumberingList to apply in place of this one. (Optional) |
