...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The GraphicLine's new shape. |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the GraphicLine. |
| Mixed | around | The point around which to flip the GraphicLine. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The location of the new GraphicLine, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | Amount by which to offset the new GraphicLine from the original GraphicLine's position. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the GraphicLine,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the GraphicLine relative to its current position, in the format (x, y). (Optional) |
...
| Boolean | clearingOverrides | If true, clears the GraphicLine's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the GraphicLine that are not defined in the object style. (Optional) |
...
| String | withProperties | Initial values for properties of the new GraphicLine. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the GraphicLine in relation to previously selected objects. (Optional) |
