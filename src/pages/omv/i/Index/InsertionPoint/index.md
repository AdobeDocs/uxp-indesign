...
*** 
> Link **createTextFragmentLink**( String **linkResourceURI**, String **name** )
> 
> Experimental: Place the text fragment fetched from url onto insertion point and create a link
#### Parameters
| Type | Name | Description |
|---|---|---|
| String | linkResourceURI | Resource URI for the link. |
...
| String | withProperties | Initial values for properties of the new InsertionPoint. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the InsertionPoint in relation to previously selected objects. (Optional) |
