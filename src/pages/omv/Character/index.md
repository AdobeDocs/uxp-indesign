...
| String | withProperties | Initial values for properties of the new Character. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the Character in relation to previously selected objects. (Optional) |
