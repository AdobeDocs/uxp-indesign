...
> The poster file.
*** 
> SoundPosterTypes **soundPosterType** 
>
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the Sound,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the Sound relative to its current position, in the format (x, y). (Optional) |
...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The Sound's new shape. |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the Sound in relation to previously selected objects. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the Sound. |
| Mixed | around | The point around which to flip the Sound. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Boolean | clearingOverrides | If true, clears the Sound's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the Sound that are not defined in the object style. (Optional) |
...
| String | withProperties | Initial values for properties of the new Sound. Above parameters can also be passed as properties (Optional) |
