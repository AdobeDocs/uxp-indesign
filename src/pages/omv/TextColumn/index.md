...
| String | withProperties | Initial values for properties of the new TextColumn. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the TextColumn in relation to previously selected objects. (Optional) |
