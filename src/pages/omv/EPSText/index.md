...
| Object | withProperties | Initial values for properties of the new EPSText (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the EPSText. |
| Mixed | around | The point around which to flip the EPSText. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The location of the new EPSText, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | Amount by which to offset the new EPSText from the original EPSText's position. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the EPSText,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the EPSText relative to its current position, in the format (x, y). (Optional) |
...
| Boolean | clearingOverrides | If true, clears the EPSText's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the EPSText that are not defined in the object style. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The EPSText's new shape. |
...
| String | withProperties | Initial values for properties of the new EPSText. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the EPSText in relation to previously selected objects. (Optional) |
