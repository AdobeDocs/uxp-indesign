...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The MultiStateObject's new shape. |
...
*** 
> **addItemsAsState**( PageItem **pageitems** )
> 
> Adds items to a specific appearance state of this object.
#### Parameters
| Type | Name | Description |
|---|---|---|
| PageItem | pageitems | One or more page items to add as a state. |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the MultiStateObject. |
| Mixed | around | The point around which to flip the MultiStateObject. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The location of the new MultiStateObject, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | Amount by which to offset the new MultiStateObject from the original MultiStateObject's position. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the MultiStateObject,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the MultiStateObject relative to its current position, in the format (x, y). (Optional) |
...
| Boolean | clearingOverrides | If true, clears the MultiStateObject's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the MultiStateObject that are not defined in the object style. (Optional) |
...
| String | withProperties | Initial values for properties of the new MultiStateObject. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the MultiStateObject in relation to previously selected objects. (Optional) |
