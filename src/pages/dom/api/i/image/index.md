...
*** 
> RenderingIntent **imageRenderingIntent** 
>
...
| Object | withProperties | Initial values for properties of the new Image (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Flip | given | The axis around which to flip the Image. |
| Mixed | around | The point around which to flip the Image. Can accept: Array of 2 Units or AnchorPoint enumerator. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The location of the new Image, specified in coordinates in the format [x, y]. Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | Amount by which to offset the new Image from the original Image's position. (Optional) |
...
| Type | Name | Description |
|---|---|---|
| Mixed | to | The new location of the Image,in the format (x, y). Can accept: Array of 2 Units, Spread, Page or Layer. (Optional) |
| Measurement Unit (Number or String)=any | by | The amount (in measurement units) to move the Image relative to its current position, in the format (x, y). (Optional) |
...
| Boolean | clearingOverrides | If true, clears the Image's existing attributes before applying the style. (Optional) |
| Boolean | clearingOverridesThroughRootObjectStyle | If true, clears attributes and formatting applied to the Image that are not defined in the object style. (Optional) |
...
| String | withProperties | Initial values for properties of the new Image. Above parameters can also be passed as properties (Optional) |
...
| Type | Name | Description |
|---|---|---|
| ConvertShapeOptions | given | The Image's new shape. |
...
| Type | Name | Description |
|---|---|---|
| SelectionOptions | existingSelection | The selection status of the Image in relation to previously selected objects. (Optional) |
